...
public class Venta {
	...
	public Venta(String iDVenta, String fecha_HS_Venta, TipoPago formadePago, edu.usal.dao.negocio.Cliente cliente,
			Vuelo vuelo, edu.usal.dao.negocio.Aerolinea aerolinea) {
		super();
		IDVenta = iDVenta;
