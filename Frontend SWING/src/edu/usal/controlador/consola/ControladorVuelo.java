...
public class ControladorVuelo {
	...
	public ControladorVuelo(VistaVuelo vista)
	{
		...
		try {
			this.Vuelo = FactoryGeneralJDBC.GetVueloImplementacion("sql");
		} catch (IOException e) {
	...
	public void MostrarMenuVuelo ()
	{
		...
		break;
			...
			case 2: System.out.println("Baja de Vuelo \n");
            System.out.println("\n");
  	         this.BajadeVuelo();
             this.MostrarMenuVuelo();
		...
		break;
			...
			case 3: System.out.println("Modificacion de Vuelo \n");
            System.out.println("\n");
		...
		break;
			...
			case 4 : System.out.println("Consulta de Vuelo \n");
		             System.out.println("\n");
		...
		break;
			...
			case 5:  System.out.println("Listado de Vuelo \n");
            System.out.println("\n");
		   	this.ListadodeVuelo();
            this.MostrarMenuVuelo();
