...
public class ControladorAerolinea {
	 ...
	 private VistaAerolinea vistaAerolinea;
		...
		public ControladorAerolinea(VistaAerolinea vista)
		{
			...
			try {
				this.Aerolinea = FactoryGeneralJDBC.GetAerolineaImplementacion("sql");
			} catch (IOException e) {
		...
		public void MostrarMenuAerolinea ()
		{
			...
			break;
				...
				case 2: System.out.println("Baja de Aerolinea \n");
	            System.out.println("\n");
			...
			break;
				...
				case 3: System.out.println("Modificacion de Aerolinea \n");
	            System.out.println("\n");
			...
			break;
				...
				case 4 : System.out.println("Consulta de Aerolinea \n");
			             System.out.println("\n");
			...
			break;
				...
				case 5:  System.out.println("Listado de Aerolinea \n");
	            System.out.println("\n");
